...
const Navbar = () => {
  ...
  return (
    <nav className="p-5 absolute top-0 left-0 w-full z-10 bg-transparent font-mona">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          ...
          <button className="hidden md:flex text-black gap-2 items-center bg-white pr-1 pl-3 py-1 rounded-full hover:bg-[#FFBB01]">
            Free Trial
