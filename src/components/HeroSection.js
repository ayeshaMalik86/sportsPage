const Hero = () => {
  return (
    <section className="relative font-mona w-full h-[750px] flex flex-col bg-cover bg-center" style={{ backgroundImage: "url('/assets/images/hero-sec-bg.jpg')" }}>
      ...
      <div className="mt-6 items-left px-6 md:px-12 text-white">
        ...
        <div className="mt-6 flex items-center justify-between">
          <a href="#" className="bg-black text-white inline-flex px-3 py-2 rounded-full text-lg flex items-center space-x-2 hover:bg-gray-800">
            <span>Join us</span>
